...
<div class="container-fluid position-relative bg-white d-flex p-0">
    ...
    <div class="form-group mb-3">
    <label for="id_voiture">Select Vehicle:</label>
    <select class="form-control" id="id_voiture" name="id_voiture" required>
        <option value="">Select Vehicle</option>
        <?php foreach ($vehiculesDisponibles as $voiture): ?>
            <option value="<?= $voiture['id'] ?>"><?= $voiture['marque'] ?> - <?= $voiture['model'] ?></option>
        <?php endforeach; ?>
    </select>
</div>
    <div class="form-group mb-3">
        <label for="date_vonte">Date of Sale:</label>
        <input type="date" class="form-control" id="date_vonte" name="date_vonte" required>
    </div>
